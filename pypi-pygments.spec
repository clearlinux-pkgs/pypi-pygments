...
Source0  : https://files.pythonhosted.org/packages/8e/62/8336eff65bcbc8e4cb5d05b55faf041285951b6e80f33e2bff2024788f31/pygments-2.18.0.tar.gz
...
%prep
%setup -q -n pygments-2.18.0
cd %{_builddir}/pygments-2.18.0
pushd ..
cp -a pygments-2.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715015619
